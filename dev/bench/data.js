    ...
    "zsh startup time": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "557482d6e0407a43eee6bdbb6b3dd3fc2e3e8184",
          "message": "chezmoi: retire targets left behind by past deletions and renames\n\nchezmoi never deletes a target it stops managing, so every source file\nremoved or renamed before .chezmoiremove existed still had its deployed\ncopy in $HOME. Walking the history (across the repo-root, home/,\ndotfiles/ and src/ source roots) and matching each old source path to\nits target turned up nine that were still present and unmanaged:\n\n- ~/.config/claude and ~/.config/prompts, whose contents all moved to\n  ~/.claude or were dropped; listed as whole directories because\n  nothing else lives in them\n- ~/.zprofile, superseded by $ZDOTDIR/.zprofile; with ZDOTDIR set in\n  .zshenv, zsh never reads it\n- scripts replaced or dropped since: eza-ls, git-ai-commit,\n  notify-to-tmux-popup.sh, insert-predefined-prompt.sh, and\n  explorer.desktop\n- permission-optimization.md\n\nThree other hits stay: ~/.config/chezmoi/chezmoi.toml is written by\nchezmoi init, ~/.config/nvim is a symlink to the nvim-config clone,\nand completions/_chezmoi is regenerated by completions_generate.",
          "timestamp": "2026-09-11T17:05:30+09:00",
          "tree_id": "cf8a49f1d1f627d24408182ee1a738433978c91b",
          "url": "https://github.com/r-okm/dotfiles/commit/557482d6e0407a43eee6bdbb6b3dd3fc2e3e8184"
        },
        "date": 1789114456889,
        "tool": "customSmallerIsBetter",
        "benches": [
