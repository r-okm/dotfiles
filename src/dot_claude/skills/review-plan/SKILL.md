---
name: review-plan
description: Reviews implementation plan files for flaws, gaps,
  and design issues before implementation.
...
- **Always write the review in Japanese.**
...
Save the review to `.ignore/reviews/plan_<plan-name>.md`.
- `<plan-name>` is the plan file's basename without extension.
  - Example: `.claude/plans/dazzling-sleeping-frost.md`
    → `.ignore/reviews/plan_dazzling-sleeping-frost.md`
- Use the Write tool directly; do not run `mkdir`.
- On re-review, overwrite the same file.
